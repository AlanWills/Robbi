...
namespace Celeste.Sound.Settings
{
    ...
    public class SoundEditorSettings : EditorSettings<SoundEditorSettings>
    {
        ...
        protected override void OnCreate()
        {
            ...
            sfxEnabled = AssetUtility.FindAsset<BoolValue>("SFXEnabled");
            musicEnabled = AssetUtility.FindAsset<BoolValue>("MusicEnabled");
            shuffleMusic = AssetUtility.FindAsset<BoolValue>("ShuffleMusic");

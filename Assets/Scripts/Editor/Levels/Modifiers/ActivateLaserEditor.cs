...
{
    [CustomEditor(typeof(ActivateLaser))]
    public class ActivateLaserEditor : LevelModifierEditor
    {
        ...
        private void OnEnable()
        {
            ...
            {
                laserEventProperty.objectReferenceValue = AssetDatabase.LoadAssetAtPath<LaserEvent>(EventFiles.LASER_ACTIVATED_EVENT);
            }
